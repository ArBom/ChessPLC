    ...
    class Chessboard
    {
        ...
        public Chessboard()
        {
            ...
            blackSBQuads = new VBO<uint>(new uint[] {0,1,10,9, 2,3,12,11, 4,5,14,13, 6,7,16,15,
                                                     ...
                                                     64,65,74,73, 66,67,76,75, 68,69,78,77, 70,71,80,79}, BufferTarget.ElementArrayBuffer);
            ...
            whiteSBQuads = new VBO<uint>(new uint[] {1,2,11,10, 3,4,13,12, 5,6,15,14, 7,8,17,16,
                                                     ...
                                                     37,38,47,46, 39,40,49,47, 41,42,51,50, 43,44,53,52,
        ...
        ~Chessboard()
        {
            ...
            whiteSBColor.Dispose();
            blackSBColor.Dispose();
